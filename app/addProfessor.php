...
$query = "INSERT INTO professor (curp, name, secondName, motherName, birthDate, sex, maritalStatus, profession, professionalId, email, phone) VALUES ('$curp','$name','$secondName','$motherName', '$birthDate', '$sex','$maritalStatus','$profession','$professionalId','$email','$phone')";
